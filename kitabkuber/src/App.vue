              ...
              <div class="h-full flex space-x-8">
                <Popover v-for="category in navigation.categories" :key="category.name" class="flex" v-slot="{ open }">
                  <div class="relative flex">
                    <PopoverButton :class="[open ? 'border-green-600 text-green-600' : 'border-transparent text-gray-700 hover:text-gray-800', 'relative z-10 flex items-center transition-colors ease-out duration-200 text-sm font-medium border-b-2 -mb-px pt-px']">
                      {{ category.name }}
                    </PopoverButton>
                  </div>
  ...
  categories: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          name: 'IIT-JEE',
          items: [
            { name: 'Rent IIT-JEE books', href: '/iit-jee/' },
          ],
        },
        {
          id: 'gmat',
          name: 'GMAT',
          items: [
            { name: 'Rent GMAT books', href: '/gmat/' },
          ],
        },
        {
          id: 'gre',
        ...
        },
        {
          ...
          name: 'IELTS',
          items: [
            { name: 'Rent IELTS books', href: '/ielts/' },
          ],
        },
        {
          id: 'toefl',
          name: 'TOEFL',
          items: [
            { name: 'Rent TOEFL books', href: '/toefl/' },
          ],
        },
      ],
    },
